  ...
  const products = [
    ...
    },
    {
      ...
      description: [
        ...
        'для сотрудников банка. Она',
        'объединяет все внутренние сервисы,',
        'информацию и инструменты в одном',
        'месте, чтобы упростить работу',
        'и ускорить процессы',
      ],
    ...
    },
    {
      ...
      description: [
        ...
        'с электронными документами и их',
        'подписания в рамках развития',
    ...
    },
    {
      ...
      description: [
        ...
        'получать виртуальные серверы и IT‑сервисы, платя только за реальное',
        'использование. Помогает быстрее',
        'создавать и запускать цифровые',
        'проекты',
      ],
