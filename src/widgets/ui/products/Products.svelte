<script lang="ts">
  ...
  const products = [
    ...
    },
    {
      id: 'vtbCloud',
      title: 'VTB Cloud',
      description: `Внутренний сервис банка для<br/>госучреждений и подконтрольных<br/>компаний. Позволяет быстро<br/>получать виртуальные
			серверы и IT‑сервисы, платя только за реальное<br/>использование. Помогает быстрее<br/>создавать и запускать
			цифровые<br/>проекты`,
